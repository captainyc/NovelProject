feature_ttr <- function(text, nchunks=NULL, chunksize=NULL, remove=NULL, normalize=FALSE, cumsum=FALSE, replicate=100) {
...
feature_entropy <- function(text, nchunks=NULL, chunksize=NULL, remove=NULL, normalize=FALSE, cumsum=FALSE, replicate=100) {
	chunks = chunk(text, nchunks, chunksize, remove)
...
feature_con_ent <- function(text, nchunks=NULL, chunksize=NULL, remove=NULL, cumsum=FALSE, replicate=100) {
	chunks = chunk(text, nchunks, chunksize, remove)
...
feature_dist_to_global <- function(text, nchunks=NULL, chunksize=NULL, remove=NULL, cumsum=FALSE, replicate=100) {
	chunks = chunk(text, nchunks, chunksize, remove)
